...
class _SettingsSheetState extends ConsumerState<SettingsSheet>
  ...
  void initState() {
    ...
    const beginOffset = Offset(1.1, 0);
  ...
  Widget buildMainSettings(BuildContext context) {
    return Consumer(
      builder: (context, ref, _) {
        ...
        void contactSupport() =>
            openUrl('mailto:$kSupportEmail?subject=Vecno Wallet support');

        void share() {
          Share.share(
            l10n.shareVecnoWalletText,
            subject: l10n.shareVecnoWalletSubject,
          );
        }
