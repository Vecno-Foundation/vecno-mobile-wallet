...
class ReceiveSheet extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final vecnoUri = VecnoUri(address: receiveAddress.address, amount: amount);
    ...
    Future<void> copyUri() async {
      try {
        await Clipboard.setData(ClipboardData(text: vecnoUri.toString()));
        UIUtil.showSnackbar(l10n.vecnoUriCopied, context);
      } catch (_) {
        UIUtil.showSnackbar(l10n.vecnoUriCopyFailed, context);
      }
    }
