...
mixin _$ApiTxInput {
 ...
 String get transactionId; int get index; String get previousOutpointHash; int get previousOutpointIndex; String get signatureScript;@JsonKey(fromJson: _sigOpCountFromJson) int get sigOpCount;// new fields
...
@useResult
$Res call({
 String transactionId, int index, String previousOutpointHash, int previousOutpointIndex, String signatureScript,@JsonKey(fromJson: _sigOpCountFromJson) int sigOpCount, String? previousOutpointAddress, int? previousOutpointAmount
});
...
as int,signatureScript: null == signatureScript ? _self.signatureScript : signatureScript // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String transactionId,  int index,  String previousOutpointHash,  int previousOutpointIndex,  String signatureScript, @JsonKey(fromJson: _sigOpCountFromJson)  int sigOpCount,  String? previousOutpointAddress,  int? previousOutpointAmount)?  $default,) {final _that = this;
switch (_that) {
case _ApiTxInput() when $default != null:
return $default(_that.transactionId,_that.index,_that.previousOutpointHash,_that.previousOutpointIndex,_that.signatureScript,_that.sigOpCount,_that.previousOutpointAddress,_that.previousOutpointAmount);case _:
  return null;
...
@override final  int previousOutpointIndex;
