...
class _AddressPublicKey extends Address {
   _AddressPublicKey({required this.prefix, required this.publicKey}): assert(publicKey.length == vPublicKeyLength),super._();
...
class _AddressPubKeyECDSA extends Address {
   _AddressPubKeyECDSA({required this.prefix, required this.publicKey}): assert(publicKey.length == vPublicKeySizeECDSA),super._();
