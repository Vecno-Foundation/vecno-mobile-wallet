...
class _SendSheetState extends ConsumerState<SendSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> scanQrCode() async {
      ...
      final prefix = ref.read(addressPrefixProvider);
      final uri = VecnoUri.tryParse(qrData, prefix: prefix);
  ...
  Widget getEnterAmountContainer() {
    return HookConsumer(builder: (context, ref, _) {
      ...
      final vecnoFormatter = ref.watch(vecnoFormatterProvider);
      ...
      void onValueChanged(String text) {
        final value = switch (fiatMode) {
          true => () {
              final price = ref.read(vecnoPriceProvider);
          ...
          false => vecnoFormatter.tryParse(text),
        };
      ...
      return FiatValueContainer(
        ...
        child: AppTextField(
          ...
          inputFormatters: [fiatMode ? fiatFormatter : vecnoFormatter],
