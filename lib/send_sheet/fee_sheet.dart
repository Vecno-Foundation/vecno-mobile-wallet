...
import '../widgets/ve_icon_widget.dart';
...
class FeeSheet extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void onValueChanged(String text) {
      final value = vecnoFormatter.tryParse(text);
        ...
        children: [
          ...
          FiatValueContainer(
            ...
            child: AppTextField(
              ...
              inputFormatters: [vecnoFormatter],
              onChanged: onValueChanged,
              textInputAction: TextInputAction.done,
              maxLines: null,
              autocorrect: false,
              hintText: hint.value ?? l10n.feePriorityHint,
              prefixButton: TextFieldButton(widget: VeIconWidget()),
