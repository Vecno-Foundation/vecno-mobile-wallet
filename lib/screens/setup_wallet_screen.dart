  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<void> setupWallet() async {
      try {
        ...
        if (introData.vpub case final vpub?) {
          final walletKind = WalletKind.localHdSchnorr(viewOnly: true);
          walletData = WalletData.vpub(
        ...
        final api = ref.read(vecnoApiServiceProvider);
        ...
        if (network == VecnoNetwork.mainnet && !introData.generated) {
