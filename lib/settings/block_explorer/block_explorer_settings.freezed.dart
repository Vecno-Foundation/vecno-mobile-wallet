...
class _BlockExplorerSettings extends BlockExplorerSettings {
  const _BlockExplorerSettings({final  Map<String, BlockExplorer> selection = const {kVecnoNetworkIdMainnet : vVecnoExplorerMainnet, kVecnoNetworkIdTestnet : vVecnoExplorerTestnet}}): _selection = selection,super._();
