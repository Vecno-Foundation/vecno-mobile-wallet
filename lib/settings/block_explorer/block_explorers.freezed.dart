...
mixin _$BlockExplorer {
 ...
 VecnoNetwork get network; String get name; String get url; String get addressUrl; String get txUrl;
...
@useResult
$Res call({
 VecnoNetwork network, String name, String url, String addressUrl, String txUrl
});
...
as VecnoNetwork,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( VecnoNetwork network,  String name,  String url,  String addressUrl,  String txUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BlockExplorer() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( VecnoNetwork network,  String name,  String url,  String addressUrl,  String txUrl)  $default,) {final _that = this;
switch (_that) {
case _BlockExplorer():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( VecnoNetwork network,  String name,  String url,  String addressUrl,  String txUrl)?  $default,) {final _that = this;
switch (_that) {
case _BlockExplorer() when $default != null:
return $default(_that.network,_that.name,_that.url,_that.addressUrl,_that.txUrl);case _:
  return null;
