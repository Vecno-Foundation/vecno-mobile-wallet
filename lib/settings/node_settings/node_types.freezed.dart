...
mixin _$NodeConfig {
 ...
 String get id; String get name; bool get isDns; bool get isSecure; List<String> get urls; VecnoNetwork get network;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,isDns,isSecure,const DeepCollectionEquality().hash(urls),network);
...
@useResult
$Res call({
 String id, String name, bool isDns, bool isSecure, List<String> urls, VecnoNetwork network
});
...
/// Create a copy of NodeConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? isDns = null,Object? isSecure = null,Object? urls = null,Object? network = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  bool isDns,  bool isSecure,  List<String> urls,  VecnoNetwork network)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NodeConfig() when $default != null:
return $default(_that.id,_that.name,_that.isDns,_that.isSecure,_that.urls,_that.network);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  bool isDns,  bool isSecure,  List<String> urls,  VecnoNetwork network)  $default,) {final _that = this;
switch (_that) {
case _NodeConfig():
return $default(_that.id,_that.name,_that.isDns,_that.isSecure,_that.urls,_that.network);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  bool isDns,  bool isSecure,  List<String> urls,  VecnoNetwork network)?  $default,) {final _that = this;
switch (_that) {
case _NodeConfig() when $default != null:
return $default(_that.id,_that.name,_that.isDns,_that.isSecure,_that.urls,_that.network);case _:
  return null;
...
class _NodeConfig extends NodeConfig {
  const _NodeConfig({required this.id, required this.name, this.isDns = false, this.isSecure = false, required final  List<String> urls, required this.network}): _urls = urls,super._();
...
@override final  VecnoNetwork network;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,isDns,isSecure,const DeepCollectionEquality().hash(_urls),network);
...
/// Create a copy of NodeConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? isDns = null,Object? isSecure = null,Object? urls = null,Object? network = null,}) {
