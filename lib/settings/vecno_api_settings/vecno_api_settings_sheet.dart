...
class VecnoApiSettingsSheet extends HookConsumerWidget {
  const VecnoApiSettingsSheet({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final apiUrl = ref.watch(vecnoApiUserSetUrlProvider);
    ...
    Future<void> setApiUrl() async {
      ...
      try {
        ...
        final notifier = ref.read(vecnoApiSettingsProvider.notifier);
      ...
      mainWidget: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              'Set a custom Vecno API URL or leave blank to use the default one.',
