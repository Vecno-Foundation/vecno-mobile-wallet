...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get exampleCardIntro =>
      'مرحبا بكم في نتريوم. بمجرد تلقي VE ، ستظهر المعاملات كما يلي:';
  ...
  String transferComplete(String amount) {
    return 'تم تحويل $amount VE إلى محفظة نتريوم.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'تم كشف محفظة برصيد $amount VE.\n';
  }
  ...
  @override
  String get transferNoFunds => 'هذا المفتاح الخاص لا يحتوي على VE';
