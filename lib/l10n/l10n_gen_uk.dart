...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Помилка додавання ноди Vecno';
  ...
  @override
  String get importVpub => 'Імпортувати гаманець тільки для перегладу';
  ...
  String get insufficientBalanceDetails =>
      'У вас недостатньо VE для даної транзакції';
  ...
  @override
  String get vecnoDevFund => 'Фонд розвитку Vecno';
  ...
  @override
  String get vecnoUriInvalid => 'Невірний URI Vecno';

  @override
  String get vecnoWallet => 'Гаманець Vecno Wallet';
  ...
  @override
  String get nodeDeleteTitle => 'Видалити конфігурацію ноди Vecno?';
  ...
  @override
  String get nodesSheetTitle => 'Ноди Vecno';
  ...
  @override
  String get shareVecnoWallet => 'Поділитися Vecno Wallet';

  @override
  String get shareVecnoWalletSubject => 'Спробуйте гаманець Vecno Wallet';

  @override
  String get shareVecnoWalletText =>
      'Спробуйте Vecno Wallet - мобільний гаманець Vecno.\nВебсайт - vecnofoundation.org';
  ...
  String transferComplete(String amount) {
    return '$amount VE успішно перераховано до вашого гаманця Vecno Wallet. \n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Виявлено гаманець з балансом $amount VE.';
  }
  ...
  String transferIntro(String button) {
    return 'Цей процес перенесе кошти з паперового гаманця у ваш гаманець Vecno Wallet.\n\nНатисніть кнопку \"$button\", щоб почати.';
  }
  ...
  @override
  String get transferNoFunds => 'Ця seed-фраза не містить VE на балансі.';
  ...
  String welcomeMessage(String version) {
    return 'Ласкаво просимо!\n\nЦе версія $version Vecno Wallet - мобільного гаманця Vecno.';
  }

  @override
  String get welcomeText =>
      'Вітаємо в Vecno Wallet. Щоб розпочати, створіть новий гаманець або імпортуйте існуючий.';
