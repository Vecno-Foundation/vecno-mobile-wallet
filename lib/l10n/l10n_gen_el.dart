...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Αποτυχία προσθήκης κόμβου Vecno';
  ...
  @override
  String get importVpubHint => 'Εισαγάγετε το εκτεταμένο δημόσιο κλειδί σας.';
  ...
  String get insufficientBalanceDetails =>
      'Δεν έχετε αρκετά VE για αυτήν την συναλλαγή';
  ...
  @override
  String get vecnoDevFund => 'Κονδύλιο προγραμματιστών VECNO';
  ...
  @override
  String get vecnoWallet => 'Το πορτοφόλι Vecno Wallet';
  ...
  @override
  String get nodeAddress => 'Κόμβος Vecno';

  @override
  String get nodeDeleteMessage => 'Είστε σίγουροι ότι θέλετε να το διαγράψετε;';

  @override
  String get nodeDeleteTitle => 'Να διαγραφούν οι ρυθμίσεις του κόμβου Vecno;';
  ...
  @override
  String get nodesSheetTitle => 'Κόμβοι Vecno';
  ...
  @override
  String get shareVecnoWallet => 'Μοιράστε το Vecno Wallet';

  @override
  String get shareVecnoWalletSubject => 'Τσεκάρετε το πορτοφόλι Vecno Wallet!';

  @override
  String get shareVecnoWalletText =>
      'Τσεκάρετε το Vecno Wallet! Το φορητό πορτοφόλι για το Vecno. Ιστοσελίδα - vecnofoundation.org';
  ...
  String transferComplete(String amount) {
    return '$amount VE μεταφέρθηκαν επιτυχώς στο Vecno Wallet πορτοφόλι σας.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Εντοπίσθηκε ένα πορτοφόλι με υπόλοιπο $amount VE.';
  }
  ...
  String transferIntro(String button) {
    return 'Η διαδικασία αυτή θα μεταφέρει τα κεφάλαιο από το χάρτινο πορτοφόλι στο πορτοφόλι Vecno Wallet.\n\nΠατήστε το  \"$button\" κουμπί για να ξεκινήσετε.';
  }
  ...
  String get transferNoFunds =>
      'Το πορτοφόλι που αντιστοιχεί σε αυτήν την μυστική φράση, δεν διαθέτει υπόλοιπο VE.';
  ...
  String get transferQrScanHint =>
      'Σαρώστε μία μυστική φράση Vecno ή ένα ιδιωτικό κλειδί.';
  ...
  String welcomeMessage(String version) {
    return 'Καλως ήρθατε!\n\nΑυτή είναι η έκδοση $version του Vecno Wallet - το φορητό πορτοφόλι για το Vecno\n ';
  }

  @override
  String get welcomeText =>
      'Καλώς ήρθατε στο Vecno Wallet. Για να ξεκινήσετε, μπορείτε να δημιουργήσετε ένα νέο πορτοφόλι ή να εισάγετε ένα υπάρχον πορτοφόλι.';
