...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get insufficientBalanceDetails =>
      'آپ کے پاس اس لین دین کے لیے کافی VE نہیں ہے';
  ...
  @override
  String get vecnoDevFund => 'کاسپا دیو فنڈ';
  ...
  @override
  String get vecnoWallet => 'کاسپیم بٹوا ';
  ...
  @override
  String get nodeDeleteTitle => 'Vecno Node Config کو حذف کریں؟';
  ...
  @override
  String get shareVecnoWallet => 'Vecno Wallet کا اشتراک کریں۔';

  @override
  String get shareVecnoWalletSubject => 'Vecno Wallet چیک کریں۔';

  @override
  String get shareVecnoWalletText =>
      'Vecno Wallet - Vecno Mobile Wallet  ویب سائٹ - vecnofoundation.org چیک کریں۔';
  ...
  String transferComplete(String amount) {
    return '$amount VE کامیابی کے ساتھ آپ کے Vecno Wallet میں منتقل ہو گیا۔\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return '$amount VE کے بیلنس والے پرس کا پتہ چلا ہے۔';
  }
  ...
  String transferIntro(String button) {
    return 'یہ عمل کاغذی بٹوے سے آپ کے Vecno Wallet والیٹ میں رقم منتقل کر دے گا۔\n\n شروع کرنے کے لیے \"$button\" بٹن کو تھپتھپائیں  ۔';
  }
  ...
  @override
  String get transferNoFunds => 'اس سیڈ پر کوئی VE نہیں ہے۔';

  @override
  String get transferQrScanError => 'اس QR کوڈ میں درست سیڈ نہیں ہے۔';

  @override
  String get transferQrScanHint => 'Vecno سیڈ یا نجی کلید اسکین کریں۔';
  ...
  String welcomeMessage(String version) {
    return 'خوش آمدید!یہ \n\n  Vecno Wallet کا ورژن $version ہے - Vecno کے لیے موبائل والیٹ';
  }

  @override
  String get welcomeText =>
      'Vecno Wallet میں خوش آمدید۔ شروع کرنے کے لیے، آپ ایک نیا پرس بنا سکتے ہیں یا پہلے سے موجود کو درآمد کر سکتے ہیں۔';
