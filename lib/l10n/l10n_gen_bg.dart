...
class AppLocalizationsBg extends AppLocalizations {
  ...
  @override
  String get buyVecnoMessage => 'Купете \$VE лесно и бързо.';
  ...
  @override
  String get buyVecnoSubtitle => 'Чрез Topper от Uphold';

  @override
  String get buyVecnoTitle => 'Купи Vecno';
  ...
  @override
  String get copyVpub => 'Копирай Vpub';
  ...
  @override
  String get importVpub => 'Импортирай портфейл само за преглед';
  ...
  @override
  String get importVpubHint => 'Моля въведете своя удължен публичен ключ.';
  ...
  @override
  String get importOptionVpubTitle => 'Импортирай портфейл само за преглед';
  ...
  String get insufficientBalanceDetails =>
      'Нямате достатъчно VE за тази транзакция';
  ...
  @override
  String get vecnoUriCopied => 'Vecno URI е копиран';

  @override
  String get vecnoUriCopyFailed => 'Неуспешно копиране на Vecno URI';

  @override
  String get vecnoUriInvalid => 'Невалиден Vecno URI';

  @override
  String get vecnoWallet => 'Vecno Wallet';

  @override
  String get vpubAuth => 'Виж разширения публичен ключ';

  @override
  String get vpubCopied => 'Разширения публичен ключ е копиран';

  @override
  String get vpubCopyFailed => 'Неуспешно копиране на разширения публичен ключ';
  ...
  @override
  String get vpubTitle => 'Разширен публичен ключ';
  ...
  @override
  String get nodeDeleteTitle => 'Изтриване на конфигурацията за Vecno нода?';
  ...
  @override
  String get nodesSheetTitle => 'Vecno нодове';
  ...
  @override
  String get shareVecnoWallet => 'Споделете Vecno Wallet';

  @override
  String get shareVecnoWalletSubject => 'Виж повече за Vecno Wallet портфейл';

  @override
  String get shareVecnoWalletText =>
      'Научете повече за Vecno Wallet - Официалният Vecno мобилен портфейл. \nУебсайт - vecnofoundation.org';
  ...
  String transferComplete(String amount) {
    return '$amount VE успешно прехвърлени към вашия Vecno Wallet портфейл.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Портфейл с баланс от $amount VE е открит.';
  }
  ...
  String transferIntro(String button) {
    return 'Този процес ще прехвърли вашите средства от Paper Wallet към Vecno Wallet.\n\nНатиснете \"$button\" бутона за старт.';
  }
  ...
  @override
  String get transferNoFunds => 'Този seed не съдържа VE';

  @override
  String get transferQrScanError => 'Този QR код не съдържа валиден seed.';

  @override
  String get transferQrScanHint => 'Сканирайте Vecno \nseed или частен ключ';
  ...
  String welcomeMessage(String version) {
    return 'Добре дошли!\n\nТова е версия $version на Vecno Wallet - мобилният портфейл за Vecno';
  }

  @override
  String get welcomeText =>
      'Добре дошли в Vecno Wallet. За да започнете, създайте нов портфейл или импортирайте вече съществуващ такъв.';
