...
abstract class AppLocalizations {
  ...
  /// No description provided for @buyVecnoMessage.
  ///
  /// In en, this message translates to:
  /// **'Buy \$VE quickly & easily.'**
  String get buyVecnoMessage;

  /// No description provided for @buyVecnoMessageSecondary.
  ///
  /// In en, this message translates to:
  /// **'Service provided by Topper, Uphold\'s fiat-to-crypto onramp.'**
  String get buyVecnoMessageSecondary;

  /// No description provided for @buyVecnoSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Via Topper by Uphold'**
  String get buyVecnoSubtitle;

  /// No description provided for @buyVecnoTitle.
  ///
  /// In en, this message translates to:
  /// **'Buy Vecno'**
  String get buyVecnoTitle;
  ...
  /// No description provided for @copyVpub.
  ///
  /// In en, this message translates to:
  /// **'Copy Vpub'**
  String get copyVpub;
  ...
  /// No description provided for @importVpub.
  ///
  /// In en, this message translates to:
  /// **'Import Watch Only Wallet'**
  String get importVpub;

  /// No description provided for @importVpubClipboardError.
  ///
  /// In en, this message translates to:
  /// **'Clipboard content is not a valid extended public key'**
  String get importVpubClipboardError;

  /// No description provided for @importVpubHint.
  ///
  /// In en, this message translates to:
  /// **'Please enter your extended public key.'**
  String get importVpubHint;

  /// No description provided for @importVpubInvalidMessage.
  ///
  /// In en, this message translates to:
  /// **'Please check that your extended public key is entered correctly!'**
  String get importVpubInvalidMessage;

  /// No description provided for @importVpubQrCodeError.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @importOptionVpubDescription.
  ///
  /// In en, this message translates to:
  /// **'Monitor the balance and transactions of a wallet using an extended public key'**
  String get importOptionVpubDescription;

  /// No description provided for @importOptionVpubTitle.
  ///
  /// In en, this message translates to:
  /// **'Import Watch Only Wallet'**
  String get importOptionVpubTitle;
  ...
  ///
  /// In en, this message translates to:
  /// **'You don\'t have enough VE for this transaction'**
  ...
  /// No description provided for @invalidVpubMessage.
  ///
  /// In en, this message translates to:
  /// **'Please check that your extended public key is entered correctly!'**
  ...
  /// No description provided for @vecnoDevFund.
  ///
  /// In en, this message translates to:
  /// **'Vecno Dev Fund'**
  String get vecnoDevFund;

  /// No description provided for @vecnoUriCopied.
  ///
  /// In en, this message translates to:
  /// **'Vecno URI Copied'**
  String get vecnoUriCopied;

  /// No description provided for @vecnoUriCopyFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to copy Vecno URI'**
  String get vecnoUriCopyFailed;

  /// No description provided for @vecnoUriInvalid.
  ///
  /// In en, this message translates to:
  /// **'Invalid Vecno URI'**
  String get vecnoUriInvalid;

  /// No description provided for @vecnoWallet.
  ///
  /// In en, this message translates to:
  /// **'Vecno Wallet'**
  String get vecnoWallet;

  /// No description provided for @vpubAuth.
  ///
  /// In en, this message translates to:
  /// **'View Extended Public Key'**
  String get vpubAuth;

  /// No description provided for @vpubCopied.
  ///
  /// In en, this message translates to:
  /// **'Extended Public Key Copied'**
  String get vpubCopied;

  /// No description provided for @vpubCopyFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to copy Extended Public Key'**
  String get vpubCopyFailed;

  /// No description provided for @vpubDescription.
  ///
  /// In en, this message translates to:
  /// **'The extended public key can be used to import your wallet as a \'watch only\' wallet.'**
  String get vpubDescription;

  /// No description provided for @vpubTitle.
  ///
  /// In en, this message translates to:
  /// **'Extended Public Key'**
  String get vpubTitle;
  ...
  /// No description provided for @shareVecnoWallet.
  ///
  /// In en, this message translates to:
  /// **'Share Vecno Wallet'**
  String get shareVecnoWallet;

  /// No description provided for @shareVecnoWalletSubject.
  ///
  /// In en, this message translates to:
  /// **'Check out Vecno Wallet'**
  String get shareVecnoWalletSubject;

  /// No description provided for @shareVecnoWalletText.
  ///
  /// In en, this message translates to:
  /// **'Check out Vecno Wallet - Vecno Mobile Wallet.\nWebsite - vecnofoundation.org'**
  ...
  /// No description provided for @themeAmoledDark.
  ///
  /// In en, this message translates to:
  /// **'Amoled Dark Theme'**
  String get themeAmoledDark;
  ...
  ///
  /// In en, this message translates to:
  /// **'{amount} VE successfully transferred to your Vecno Wallet.\n'**
  String transferComplete(String amount);

  /// No description provided for @transferConfirmInfo.
  ///
  /// In en, this message translates to:
  /// **'A wallet with a balance of {amount} VE has been detected.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This process will transfer the funds from a paper wallet to your Vecno Wallet wallet.\n\nTap the \"{button}\" button to start.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This seed does not have any VE on it'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Welcome!\n\nThis is version {version} of Vecno Wallet - the mobile wallet for Vecno'**
  String welcomeMessage(String version);

  /// No description provided for @welcomeText.
  ///
  /// In en, this message translates to:
  /// **'Welcome to Vecno Wallet. To begin, you may create a new wallet or import an existing one.'**
