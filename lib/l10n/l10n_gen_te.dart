...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'vecno నోడ్  జోడించడంలో విఫలమైంది';
  ...
  @override
  String get importVpub => 'వాచ్ మాత్రమే వాలెట్‌ని దిగుమతి చేయండి';
  ...
  @override
  String get importOptionVpubTitle => 'వాచ్ మాత్రమే వాలెట్‌ని దిగుమతి చేయండి';
  ...
  String get insufficientBalanceDetails =>
      'ఈ లావాదేవీ కోసం మీ వద్ద తగినంత VE లేదు';
  ...
  @override
  String get vecnoDevFund => 'కస్పా Dev ఫండ్';
  ...
  @override
  String get vecnoUriInvalid => 'చెల్లని Vecno URI';

  @override
  String get vecnoWallet => 'కాస్పియం వాలెట్';
  ...
  @override
  String get nodeAddress => 'vecno నోడ్';

  @override
  String get nodeDeleteMessage => 'మీరు తొలగించాలనుకుంటున్నారా ఖచ్చితంగా?';

  @override
  String get nodeDeleteTitle => 'Vecno నోడ్ కాన్ఫిగర్‌ని తొలగించాలా?';
  ...
  @override
  String get nodesSheetTitle => 'Vecno నోడ్స్';
  ...
  @override
  String get shareVecnoWallet => 'కాస్పియం యాప్‌ను భాగస్వామ్యం చేయండి';

  @override
  String get shareVecnoWalletSubject => 'కాస్పియం వాలెట్‌ని తనిఖీ చేయండి';

  @override
  String get shareVecnoWalletText =>
      'కాస్పియం - Vecno మొబైల్ వాలెట్‌ని తనిఖీ చేయండి.\nవెబ్సైట్ - vecnofoundation.org';
  ...
  String transferComplete(String amount) {
    return '$amount VE మీ కాస్పియం వాలెట్కి విజయవంతంగా బదిలీ చేయబడింది.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return '$amount VE బ్యాలెన్స్ ఉన్న వాలెట్ కనుగొనబడింది.';
  }
  ...
  @override
  String get transferNoFunds => 'ఈ Seedలో VE ఏదీ లేదు';

  @override
  String get transferQrScanError => 'ఈ QR కోడ్‌లో చెల్లుబాటు అయ్యే Seed లేదు.';

  @override
  String get transferQrScanHint => 'స్కాన్ చేయండి Vecno\nSeed లేదా ప్రైవేట్ కీ';
  ...
  String welcomeMessage(String version) {
    return 'స్వాగతం!\n\nఇది కాస్పియం యొక్క వెర్షన్ $version - Vecno కోసం మొబైల్ వాలెట్';
  }
