...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get buyVecnoMessage => 'VE\$ را سریع و آسان بخرید.';
  ...
  @override
  String get buyVecnoSubtitle => 'Via Topper توسط Uphold';

  @override
  String get buyVecnoTitle => 'خرید Vecno';
  ...
  @override
  String get importVpub => 'وارد کردن کیف پول Watch Only';
  ...
  @override
  String get importVpubHint => 'لطفا کلید عمومی توسعه یافته خود را وارد کنید.';
  ...
  @override
  String get importOptionVpubTitle => 'وارد کردن کیف پول Watch Only';
  ...
  @override
  String get insufficientBalanceDetails => 'شما VE کافی برای این تراکنش ندارید';
  ...
  @override
  String get vecnoDevFund => 'صندوق توسعه دهندگان Vecno';

  @override
  String get vecnoUriCopied => 'Vecno URI کپی شد';

  @override
  String get vecnoUriCopyFailed => 'Vecno URI کپی نشد';

  @override
  String get vecnoUriInvalid =>
      ' Vecno URI یا شناسه منبع یکپارچه Vecno نامعتبر است';

  @override
  String get vecnoWallet => 'کیف پول Vecno Wallet';

  @override
  String get vpubAuth => 'نمایش کلید عمومی توسعه یافته';

  @override
  String get vpubCopied => 'کلید عمومی توسعه یافته کپی شد';

  @override
  String get vpubCopyFailed => 'کلید عمومی توسعه یافته کپی نشد';
  ...
  @override
  String get vpubTitle => 'کلید عمومی توسعه یافته';
  ...
  @override
  String get nodeAddress => 'نود Vecno';

  @override
  String get nodeDeleteMessage => 'آیا مطمئن هستید که می خواهید حذف کنید؟';

  @override
  String get nodeDeleteTitle => 'پیکربندی نود Vecno حذف شود؟';
  ...
  @override
  String get nodesSheetTitle => 'نودهای Vecno';
  ...
  @override
  String get shareVecnoWallet => 'اشتراک گذاری Vecno Wallet';

  @override
  String get shareVecnoWalletSubject => 'بررسی کیف پول Vecno Wallet';

  @override
  String get shareVecnoWalletText =>
      'بررسی Vecno Wallet - کیف پول موبایلی Vecno\nوبسایت - vecnofoundation.org';
  ...
  String transferComplete(String amount) {
    return 'تعداد $amount VE با موفقیت به کیف پول Vecno Wallet شما منتقل شد.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'کیف پولی با موجودی $amount VE شناسایی شد.';
  }
  ...
  String transferIntro(String button) {
    return 'این فرآیند وجوه را از کیف پول کاغذی به کیف پول Vecno Wallet شما منتقل خواهد کرد.\n\nبرای شروع، \"$button\" را لمس کنید.';
  }
  ...
  @override
  String get transferNoFunds => 'این seed شامل هیچ VE نمی باشد';

  @override
  String get transferQrScanError => 'این QR کد شامل هیچ seed معتبری نیست.';

  @override
  String get transferQrScanHint => 'اسکن Vecno\nseed یا کلید خصوصی';
  ...
  String welcomeMessage(String version) {
    return 'خوش آمدید!\n\nاین نسخه شماره $version Vecno Wallet است - کیف پول موبایلی Vecno';
  }

  @override
  String get welcomeText =>
      'به Vecno Wallet خوش آمدید. برای شروع، می توانید یک کیف پول جدید بسازید یا کیف پول موجود را وارد کنید.';
