...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Не удалось добавить ноду Vecno';
  ...
  @override
  String get importVpub => 'Импортировать кошелек только для просмотра';
  ...
  String get insufficientBalanceDetails =>
      'У вас не хватает VE для этой транзакции';
  ...
  @override
  String get vecnoDevFund => 'Фонд разработки Каспы';
  ...
  @override
  String get vecnoUriInvalid => 'Недействительный URI Vecno';

  @override
  String get vecnoWallet => 'Кошелёк Vecno Wallet';
  ...
  @override
  String get nodeAddress => 'Нода Vecno';

  @override
  String get nodeDeleteMessage => 'Вы уверены, что хотите удалить?';

  @override
  String get nodeDeleteTitle => 'Удалить конфигурацию ноды Vecno?';
  ...
  @override
  String get nodesSheetTitle => 'Ноды Vecno';
  ...
  @override
  String get shareVecnoWallet => 'Поделиться Vecno Wallet';

  @override
  String get shareVecnoWalletSubject => 'Попробуйте кошелёк Vecno Wallet';

  @override
  String get shareVecnoWalletText =>
      'Попробуйте Vecno Wallet - мобильный кошелёк Vecno.\nВеб-сайт - vecnofoundation.org';
  ...
  String transferComplete(String amount) {
    return '$amount VE успешно переведено в кошелёк Vecno Wallet.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Обнаружен кошелёк с балансом $amount VE.';
  }
  ...
  String transferIntro(String button) {
    return 'Этот процесс переведёт средства с бумажного кошелька на ваш кошелёк Vecno Wallet.\n\nНажмите кнопку \"$button\" чтобы начать.';
  }
  ...
  @override
  String get transferNoFunds => 'Эта seed-фраза не имеет VE.';
  ...
  String welcomeMessage(String version) {
    return 'Добро пожаловать!\n\nЭто версия $version Vecno Wallet - мобильного кошелька Vecno';
  }

  @override
  String get welcomeText =>
      'Добро пожаловать в Vecno Wallet. Вы можете создать новый кошелек или импортировать уже существующий.';
