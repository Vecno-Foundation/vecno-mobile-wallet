...
import '../vecno/transaction/mass_calculator.dart';
...
abstract class UIUtil {
  ...
  static String authMessage({
    ...
    if (fee != null && fee != BigInt.zero) {
      final vecno = TokenInfo.vecno;
      final feeStr = NumberUtil.approxAmountRaw(fee, vecno.decimals);
