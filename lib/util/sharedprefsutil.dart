...
class SharedPrefsUtil {
  ...
  // Keys
  static const String first_launch_key = 'fvecnowallet_first_launch';
  static const String auth_method = 'fvecnowallet_auth_method';
  static const String cur_currency = 'fvecnowallet_currency_pref';
  static const String cur_language = 'fvecnowallet_language_pref';
  static const String cur_theme = 'fvecnowallet_theme_pref';
  static const String firstcontact_added = 'fvecnowallet_first_contact_added';
  // If user has seen the root/jailbreak warning yet
  static const String has_shown_root_warning = 'fvecnowallet_root_warn';
  static const String notice_shown = 'fvecnowallet_notice_shown';
  ...
  ThemeSetting getTheme() {
    return ThemeSetting(ThemeOptions.values.byName(get(
      cur_theme,
      defaultValue: ThemeOptions.VECNOWALLET_AMOLED_DARK.name,
    )));
  }
