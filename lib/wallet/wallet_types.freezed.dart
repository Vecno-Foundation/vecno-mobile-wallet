...
mixin _$BoxInfoByNetwork {
 ...
 BoxInfo get mainnet; BoxInfo get testnet; BoxInfo get simnet;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BoxInfoByNetwork&&(identical(other.mainnet, mainnet) || other.mainnet == mainnet)&&(identical(other.testnet, testnet) || other.testnet == testnet)&&(identical(other.simnet, simnet) || other.simnet == simnet));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,mainnet,testnet,simnet);

@override
String toString() {
  return 'BoxInfoByNetwork(mainnet: $mainnet, testnet: $testnet, simnet: $simnet)';
}
...
@useResult
$Res call({
 BoxInfo mainnet, BoxInfo testnet, BoxInfo simnet
});


$BoxInfoCopyWith<$Res> get mainnet;$BoxInfoCopyWith<$Res> get testnet;$BoxInfoCopyWith<$Res> get simnet;
...
/// Create a copy of BoxInfoByNetwork
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mainnet = null,Object? testnet = null,Object? simnet = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( BoxInfo mainnet,  BoxInfo testnet,  BoxInfo simnet)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BoxInfoByNetwork() when $default != null:
return $default(_that.mainnet,_that.testnet,_that.simnet);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( BoxInfo mainnet,  BoxInfo testnet,  BoxInfo simnet)  $default,) {final _that = this;
switch (_that) {
case _BoxInfoByNetwork():
return $default(_that.mainnet,_that.testnet,_that.simnet);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( BoxInfo mainnet,  BoxInfo testnet,  BoxInfo simnet)?  $default,) {final _that = this;
switch (_that) {
case _BoxInfoByNetwork() when $default != null:
return $default(_that.mainnet,_that.testnet,_that.simnet);case _:
  return null;
...
class _BoxInfoByNetwork extends BoxInfoByNetwork {
  const _BoxInfoByNetwork({required this.mainnet, required this.testnet, required this.simnet}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BoxInfoByNetwork&&(identical(other.mainnet, mainnet) || other.mainnet == mainnet)&&(identical(other.testnet, testnet) || other.testnet == testnet)&&(identical(other.simnet, simnet) || other.simnet == simnet));
}
...
@override $BoxInfoCopyWith<$Res> get mainnet;@override $BoxInfoCopyWith<$Res> get testnet;@override $BoxInfoCopyWith<$Res> get simnet;
...
/// Create a copy of BoxInfoByNetwork
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mainnet = null,Object? testnet = null,Object? simnet = null,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _WalletDataSeed value)?  seed,TResult Function( _WalletDataKpub value)?  vpub,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _WalletDataSeed() when seed != null:
return seed(_that);case _WalletDataKpub() when vpub != null:
return vpub(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _WalletDataSeed value)  seed,required TResult Function( _WalletDataKpub value)  vpub,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _WalletDataSeed value)?  seed,TResult? Function( _WalletDataKpub value)?  vpub,}){
final _that = this;
switch (_that) {
case _WalletDataSeed() when seed != null:
return seed(_that);case _WalletDataKpub() when vpub != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String name,  WalletKind kind,  String seed,  bool usesBip39Passphrase,  String? mnemonic,  String? password)?  seed,TResult Function( String name,  WalletKind kind,  String vpub)?  vpub,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WalletDataSeed() when seed != null:
return seed(_that.name,_that.kind,_that.seed,_that.usesBip39Passphrase,_that.mnemonic,_that.password);case _WalletDataKpub() when vpub != null:
return vpub(_that.name,_that.kind,_that.vpub);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String name,  WalletKind kind,  String seed,  bool usesBip39Passphrase,  String? mnemonic,  String? password)  seed,required TResult Function( String name,  WalletKind kind,  String vpub)  vpub,}) {final _that = this;
switch (_that) {
case _WalletDataSeed():
...
return vpub(_that.name,_that.kind,_that.vpub);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String name,  WalletKind kind,  String seed,  bool usesBip39Passphrase,  String? mnemonic,  String? password)?  seed,TResult? Function( String name,  WalletKind kind,  String vpub)?  vpub,}) {final _that = this;
switch (_that) {
case _WalletDataSeed() when seed != null:
return seed(_that.name,_that.kind,_that.seed,_that.usesBip39Passphrase,_that.mnemonic,_that.password);case _WalletDataKpub() when vpub != null:
return vpub(_that.name,_that.kind,_that.vpub);case _:
...
class _WalletDataKpub implements WalletData {
  const _WalletDataKpub({required this.name, required this.kind, required this.vpub});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WalletDataKpub&&(identical(other.name, name) || other.name == name)&&(identical(other.kind, kind) || other.kind == kind)&&(identical(other.vpub, vpub) || other.vpub == vpub));
}


@override
int get hashCode => Object.hash(runtimeType,name,kind,vpub);

@override
String toString() {
  return 'WalletData.vpub(name: $name, kind: $kind, vpub: $vpub)';
}
...
@override @useResult
$Res call({
 String name, WalletKind kind, String vpub
});
...
/// Create a copy of WalletData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? kind = null,Object? vpub = null,}) {
  return _then(_WalletDataKpub(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,kind: null == kind ? _self.kind : kind // ignore: cast_nullable_to_non_nullable
as WalletKind,vpub: null == vpub ? _self.vpub : vpub // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
