import '../vecno/utils.dart';
import '../util/encryption_util.dart';
import '../util/vault.dart';

const _vMnemonicKey = 'vecnowallet_mnemonic_key';
const _vSeedKey = 'vecnowallet_seed_key';
...
class WalletVault {
  ...
  const WalletVault(String wid, this.vault)
      : _mnemonicKey = '$_vMnemonicKey#$wid',
        _seedKey = '$_vSeedKey#$wid';
