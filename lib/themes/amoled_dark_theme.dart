...
class VecnoAmoledDarkTheme extends BaseTheme {
  ...
  Color background40 = amoledDark.withValues(alpha: 0.4);
  Color background00 = amoledDark.withValues(alpha: 0.0);

  Color backgroundDark = amoledDark;
  Color backgroundDark00 = amoledDark.withValues(alpha: 0.0);

  Color backgroundDarkest = blueishGreyDark;
