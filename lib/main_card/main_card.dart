...
import '../vecno/types.dart';
import '../l10n/l10n.dart';
import '../themes/vecno_light_theme.dart';
...
class MainCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final vecnoBalance = ref.watch(formatedTotalBalanceProvider);
    final fiatBalance = ref.watch(formatedTotalFiatProvider);
    final vecnoPrice = ref.watch(formatedVecnoPriceProvider);
    ...
    Future<void> scanQrCode() async {
      ...
      final uri = VecnoUri.tryParse(data, prefix: prefix);
                      ...
                      Container(
                        child: FittedBox(
                          ...
                          child: Row(
                            children: [
                              Image.asset(
                                'assets/vecno_transparent_180.png',
                                width: 30,
                                color: theme is VecnoLightTheme
                                    ? theme.primary
                                    : null,
                              ),
